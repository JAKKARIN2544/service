...
<ul class="navbar-nav">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <p class="nav-link text-dark" >
              <img src="assets/dist/img/avatar/avatar1.png" alt="" class="brand-image img-circle elevation-0 mb-1" style="opacity: 1; width: 30px;">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="avatar text-center mt-3">
        <img src="assets/dist/img/avatar/avatar1.png" class="brand-image img-circle elevation-3" alt="User Image" width="58px">
      </div>
      <div class="user-panel mt-1 text-center">
        <div class="info">
          <a href="service.php" class="d-block"><?php echo  $row1['officer_fristname'].' '.$row1['officer_lastname']; ?></a>
        </div>
      </div>
          ...
          <li class="nav-item">
            <li class="nav-item">
                <a href="service.php" class="nav-link">
                  ...
                  <p>ติดตามการซ่อม</p>
                  <span class="badge badge-warning right ml-5"> 51 NEW</span>
                </a>
              </li>
          </li>
