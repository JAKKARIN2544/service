                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        <img src="assets/dist/img/avatar/avatar7.png" alt=""
                        ...
                        <div class="col-lg-7">
                            <div class="card">
                                <div class="card-body">
                                <form action="service.php?update=<?php echo MD5('update_profile_users') ?>" method="POST" class="form-horizontal">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="" class="col-sm-2 col-form-label">ชื่อ - สกุล</label>
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" name="frist_name" value="<?php echo  $row2['frist_name']; ?>">
                                                    <small>ชื่อ <small class="text-danger">*</small></small>
                                                </div>
                                                <div class="col-sm-5">
                                                    <input type="text" class="form-control" name="last_name"  value="<?php echo  $row2['last_name']; ?>">
