                        ...
                        <div class="col-md-6">
                            <div class="card mt-5">
                                <div class="text-center mt-3">
                                    <h4><i class="fas fa-users-cog"></i> เข้าสู่ระบบ เจ้าหน้าที่</h4>
                                </div>
                                <div class="container"> 
                                <div class="alert alert-bg alert-dismissible">
                                    ...
                                    หากยังไม่มีบัญชีผู้ใช้งาน ติดต่อผู้ดูแลระบบ !!
                                </div>
                                </div>
                                <div class="card-body">
                                    <form action="service.php?login=<?php echo MD5('login_officer') ?>" method="POST">
