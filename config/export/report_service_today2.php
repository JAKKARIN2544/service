...
<body>
    ...
    <h1>รายงานอุปกรณ์ที่กำลังซ่อมวันนี้</h1>
    <table>
        <tr>
        ...
        $sql = "SELECT tb_service_detail.*,tb_status.status_name_th
                ...
                WHERE user_id = '".$_SESSION['id']."' AND service_date = DATE(CURRENT_TIMESTAMP) AND status = 'being' ";
...
$mpdf->WriteHTML($html);
$taget = "src/pdf/รายงานอุปกรณ์ที่กำลังซ่อมวันนี้.pdf";
$mpdf->Output($taget);
