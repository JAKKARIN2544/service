...
<body>
    ...
    <table>
        ...
        $sql = "SELECT tb_service_detail.*,tb_status.status_name_th
                ...
                WHERE user_id = '".$_SESSION['id']."' AND service_date = DATE(CURRENT_TIMESTAMP) AND status = 'estimate' ";
...
$mpdf->WriteHTML($html);
$taget = "src/pdf/รายงานการส่งซ่อมวันนี้.pdf";
$mpdf->Output($taget);
